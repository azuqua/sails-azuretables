...
module.exports = (function(){
  ...
  var adapter = {
    ...
    registerCollection: function(collection, cb) {
      ...
      collection.account = typeof collection.config.account !== "undefined" ? collection.config.account : collection.account;
      collection.secret = typeof collection.config.secret !== "undefined" ? collection.config.secret : collection.secret;
